...
caveman = Item(
	user_id=1,
	name="Caveman", 
	description="This would-be inventor from the prehistoric past is always tinkering with sticks, rocks and the occasional bricks he finds lying around, trying to invent something new.", 
	category=series1,
...
cheerleader = Item(
	user_id=1,
	name="Cheerleader", 
	description='"Gimmie an L! Gimmie an E! Gimmie a G! Gimmie an O! Yaaay!"  The Cheerleader is perpetually filled to bursting with energy, excitement and enthusiasm. She prefers cartwheels and handsprings to plain old ordinary walking, and she waves her pom-poms around wildly whenever she talks, which is pretty much all of the time.', 
	category=series1,
...
robot= Item(
	user_id=1,
	name="Robot",
	description="He's slow to react to things that he doesn't expect, and prone to occasional short-circuits, with a tendency to walk right into holes, spin around suddenly in place or crash through walls without even noticing.",
	category=series1,
...
disco=Item(
	user_id=1,
	name="Disco Dude",
	description="The Disco Dude has traveled back in time to relive the days of disco dancing, bell-bottom pants and the very first LEGO Space sets.",
	category=series2,
...
alien=Item(
	user_id=1,
	name="Space Alien",
	description="Nobody knows where the Space Alien came from or how it got here. It just showed up one day with a map of the planet and an Alien-to-Human dictionary, but neither one works very well.",
	category=series3,
